...
const FriendsList = () => {
  return (
    <div class=" md:w-[90%] md:h-[95%] border-[1px] md:mt-[5%] rounded-lg flex flex-col  m-auto items-center md:pt-[5%] justify-around ">
      <input
      ...
      <div class="flex flex-col w-[90%] h-[100%] rounded-lg justify-around items-center overflow-hidden mt-[5%]">
        {friends.map((item) => (
          <div class="flex flex-row h-[8vh] items-center justify-around border-[1px] p-[5%] w-[90%] rounded-lg mb-[5%] hover:bg-[#2f3336]">
