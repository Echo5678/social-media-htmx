    ...
    <div class="flex">
      ...
      <main class="w-full">
        ...
        >
          ...
          />
          <input id="blog" name="blog" type="hidden" value=" " class="hidden" />
          <div
            id="editor"
            class="prose prose-stone dark:prose-invert sm:prose-lg lg:prose-xl max-w-none p-6 border border-zinc-200 dark:border-zinc-800 rounded-lg h-full mt-2"
          ></div>
          <button
            type="submit"
