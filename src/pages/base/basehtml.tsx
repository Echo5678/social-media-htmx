    ...
    <html lang="en">
      <head>
        ...
        <meta
          ...
          content="script-src https://unpkg.com/htmx.org@1.9.5 https://cdn.tailwindcss.com https://unpkg.com/htmx.org/dist/ext/response-targets.js https://unpkg.com/htmx.org/dist/ext/preload.js"
        ></meta>
        <title>CoDev</title>
        <link
          rel="icon"
